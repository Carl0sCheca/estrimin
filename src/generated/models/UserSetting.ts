...
export type UserSettingOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "value" | "userId", ExtArgs["result"]["userSetting"]>
...
export interface UserSettingDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const userSettingWithKeyOnly = await prisma.userSetting.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many UserSettings and only return the `key`
   * const userSettingWithKeyOnly = await prisma.userSetting.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more UserSettings and only return the `key`
   * const userSettingWithKeyOnly = await prisma.userSetting.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
